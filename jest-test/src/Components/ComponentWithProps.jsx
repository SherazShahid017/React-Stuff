...
const ComponentWithProps = (props) => {
    ...
    return (
        <>
            ...
            <p className="number">The value of the numeric prop is: {numericProp}</p>
            <p className="bigNumber"> The value of the valueProp is : {valueProp}</p>
            <p className="expressed">{expressionProp}</p>
            <p className="function"> FunctionProp returns: {functionProp()}</p>
